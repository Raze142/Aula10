...
var playerScore= 0;
var compScore= 0;
//variavel para armazenar diferentes estagios de jogo
var gameState = "serve";
...
function draw() {
 ...
 //Redefina o atacante adicionando o valor de x e y
 striker.x= 200;
 striker.y= 200;
 striker.velocityX= 0;
 striker.velocityY= 0;
...
if(striker.isTouching(goal1)|| playerScore == 5)//adicione a condição para verificar se a pontuação do jogador chegou a 5
{
fill("maroon");
textSize(24);
...
textSize(18);
fill("maroon");
text("Precione spaço para atacar",120,180);
